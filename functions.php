...
function custom_scripts() {
	...
	wp_enqueue_script('bootstrap_js',get_template_directory_uri().'/js/bootstrap.js',array("jquery"),'3.3',true);
	wp_enqueue_script('my-custom',get_template_directory_uri().'/js/custom.js',array("jquery"),'3.3',true);
	wp_enqueue_script('jquery');
	//wp_enqueue_script('jquery-js',get_template_directory_uri().'/js/jquery.js',array(),'3.3.1',true);

	/* My Very Own Custom Script */
